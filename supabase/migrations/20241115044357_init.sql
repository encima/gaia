...
--   where issue_comments.embedding <=> query_embedding < 1 - match_threshold
--   order by issue_comments.embedding <=> query_embedding
--   limit match_count;
-- $$;
...
--   order by issues.embedding <=> query_embedding
--   limit match_count;
-- $$;
